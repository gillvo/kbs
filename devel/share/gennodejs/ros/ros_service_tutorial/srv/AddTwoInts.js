...
// (in-package ros_service_tutorial.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'ros_service_tutorial/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_service_tutorial/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ros_service_tutorial/AddTwoInts'; }
};
